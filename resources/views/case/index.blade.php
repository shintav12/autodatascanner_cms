            ...
            var dataTable = $('#user').DataTable({
                ...
                "aoColumnDefs": [
                    ...
                    },
                    {
                        ...
                        "mData": null,
                        "mRender": function (data, type, full) {
                            return '<a href="{{url("cases/detail")}}/' + full.id + '" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;Editar</a>';
                        }
        ...
        <div class="col-xs-12">
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <a href="{{route('case_detail')}}" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;Nuevo</a>
                    <div class="tools"> </div>
                </div>
