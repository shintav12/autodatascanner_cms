                ...
                submitHandler: function (form) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (error == 0) {
                                window.location = "{{ url(route('failure_codes'))}}";
                            } else {
                                swal.close();
                                swal(
                                    'Oops...',
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="description" value="<?php if( isset($item) )  echo $item->description;?>" placeholder="Ingrese el nombre de la marca">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3 col-md-9">
                                        ...
                                        <a type="button" href="{{route('failure_codes')}}" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
