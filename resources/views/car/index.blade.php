            ...
            var dataTable = $('#user').DataTable({
                ...
                "aoColumnDefs": [
                    ...
                    },
                    {
                        ...
                        "mData": null,
                        "mRender": function (data, type, full) {
                            return '<a href="{{url("cars/detail")}}/' + full.id + '" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;Editar</a>';
                        }
        ...
        <div class="col-xs-12">
            <div class="portlet light portlet-fit portlet-datatable bordered">
                <div class="portlet-title">
                    <a href="{{route('car_detail')}}" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;Nuevo</a>
                    <div class="tools"> </div>
                </div>
                    ...
                    <div class="table-container" style="margin-top: 30px;">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="user" style="margin-top: 25px">
                            ...
                            <tr>
                                ...
                                <th style="text-align: left;" width="20%"> Modelo </th>
