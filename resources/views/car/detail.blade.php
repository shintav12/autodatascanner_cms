                ...
                submitHandler: function (form) {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (error == 0) {
                                window.location = "{{ url(route('cars'))}}";
                            } else {
                                swal.close();
                                swal(
                                    'Oops...',
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-xs-12">
                                                    <label>Modelo</label>
                                                    <input type="text" class="form-control" name="name" value="<?php if( isset($item) )  echo $item->name;?>" placeholder="Ingrese el nombre del modelo">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-xs-12">
                                                    <label>Year</label>
                                                    <input type="number" maxlength="4" minlength="4" class="form-control" name="year" value="<?php if( isset($item) )  echo $item->year;?>" placeholder="Ingrese el año de la marca">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <div class="col-xs-12">
                                                    <label>Motor</label>
                                                    <input type="text" class="form-control" name="engine" value="<?php if( isset($item) )  echo $item->engine;?>" placeholder="Ingrese el nombre del motor">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-xs-12">
                                                    ...
                                                    <select class="form-control" name="brand_id">
                                                        @foreach($brands as $brand)
                                                            <option value="{{$brand->id}}" <?php if(isset($item)) if($item->brand_id == $brand->id) echo "selected"?> >{{$brand->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="col-md-3 col-md-9">
                                        ...
                                        <a type="button" href="{{route('cars')}}" class="btn default">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </div>
